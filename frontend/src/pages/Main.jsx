...
import Lottie from 'lottie-react'; // Assuming you're using lottie-react for animations
...
const Main = () => {
  ...
  return (
    <div className="flex flex-col bg-lightGray text-darkGray items-center gap-10 w-[90%] m-auto">
      <div className="flex flex-col items-center justify-center  md:grid md:grid-cols-2  gap-8 mt-10 ">
        <div className="flex flex-col items-start gap-4 animate-slideInFromLeft">
          ...
          <Link
            to={'/Features'}
            className="bg-primary p-2 mt-2 text-white rounded-md"
          >
            WHAT WE OFFER
          </Link>
        </div>
